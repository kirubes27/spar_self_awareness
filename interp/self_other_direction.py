...
def main():
    ...
    # TESTING MODE: Use only 5 pairs to verify everything works
    pairs_train = pairs_train[:5]
    pairs_test = pairs_test[:5]
    print("⚠️ TESTING MODE: Using only 5 train + 5 test pairs\n")
